...
panel serve --port ${PORT} --cookie-secret my_super_safe_cookie_secret --autoreload --address 0.0.0.0 --log-level ${LOG_LEVEL} --index /assets/custom_index.html --static-dirs assets=/assets --allow-websocket-origin='*'  /trj /tspt /OGC_client  --index-titles /trj="trj" /tspt="Time Series Profile Tool" /csw="OGC Client"
